...
\begin{entrylist}
  \entry
    ...
    •	Designed and lead Junior engineers to create a dashboard that made RPS health understandable to customers\\*
    ...
    •	Worked closely with stakeholders to develop the JSON Builder step in IntegrationHub using React\\*
...
•	Pentesting
•	James Mickens
•	Use Prometheus to monitor my ISP's uptime
